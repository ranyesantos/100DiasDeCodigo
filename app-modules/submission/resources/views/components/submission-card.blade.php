...
<div class="flex items-center justify-center p-4">
    <div
        class="w-full max-w-[550px] overflow-hidden rounded-xl border border-gray-200 bg-white font-sans shadow-sm dark:border-gray-700 dark:bg-gray-900"
    >
        <div class="p-4 pb-0">
        ...
        @if ($tweet->extendedEntities?->media || $tweet->entities?->media)
            ...
            @if ($media)
                <div class="relative mx-4 mb-3 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700">
                    <img
                        alt="Tweet media"
        ...
        <div class="flex items-center gap-1 px-4 pb-3 text-[15px] text-gray-500 dark:text-gray-400">
            <span>{{ $submission->submitted_at->format('g:i A · M j, Y') }}</span>
        </div>
        ...
        <div class="flex items-center gap-6 px-4 py-3">
            <div class="group flex items-center gap-2 text-gray-500 dark:text-gray-400">
                <x-filament::icon icon="heroicon-o-heart" class="h-5 w-5 transition-colors group-hover:text-red-500" />
